# ECS Cluster - The container orchestration environment
...
# IAM Role for ECS Task Execution (allows ECS to pull images, write logs)
...
# ECS Task Definition - Defines how containers should run
...
resource "aws_ecs_service" "app" {
  ...
  # Health check grace period (time to allow app to start)
  health_check_grace_period_seconds = 60

  # Wait for ALB to be created first
